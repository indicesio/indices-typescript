...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    stainlessPath: '(resource) beta.connectors > (method) list',
    qualified: 'client.beta.connectors.list',
    params: ['cursor?: string;', 'domain?: string;', 'limit?: number;'],
    response:
      "{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }",
    markdown:
      "## list\n\n`client.beta.connectors.list(cursor?: string, domain?: string, limit?: number): { id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: secret_slot_definition[]; }`\n\n**get** `/v1beta/connectors`\n\n<p>List the connectors in your catalog.</p>\n\n### Parameters\n\n- `cursor?: string`\n  Cursor from a previous response's `next_cursor`, to fetch the next page.\n\n- `domain?: string`\n  Only connectors whose website is this domain or a subdomain of it.\n\n- `limit?: number`\n  Maximum number of connectors to return.\n\n### Returns\n\n- `{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `display_name: string`\n  - `input_schema: object`\n  - `output_schema: object`\n  - `purpose: string`\n  - `revised_from_connector_id: string`\n  - `website: string`\n  - `required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\n// Automatically fetches more pages as needed.\nfor await (const connector of client.beta.connectors.list()) {\n  console.log(connector);\n}\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.connectors.list',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const connector of client.beta.connectors.list()) {\n  console.log(connector.id);\n}",
      },
      python: {
        method: 'beta.connectors.list',
        example:
          'import os\nfrom indices import Indices\n\nclient = Indices(\n    api_key=os.environ.get("INDICES_API_KEY"),  # This is the default and can be omitted\n)\npage = client.beta.connectors.list()\npage = page.data[0]\nprint(page.id)',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.connectors > (method) retrieve',
    qualified: 'client.beta.connectors.retrieve',
    params: ['connector_id: string;'],
    response:
      "{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }",
    markdown:
      "## retrieve\n\n`client.beta.connectors.retrieve(connector_id: string): { id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: secret_slot_definition[]; }`\n\n**get** `/v1beta/connectors/{connector_id}`\n\n<p>Retrieve a connector by its ID.</p>\n\n### Parameters\n\n- `connector_id: string`\n  The ID of the connector to retrieve.\n\n### Returns\n\n- `{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `display_name: string`\n  - `input_schema: object`\n  - `output_schema: object`\n  - `purpose: string`\n  - `revised_from_connector_id: string`\n  - `website: string`\n  - `required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst connector = await client.beta.connectors.retrieve('connector_id');\n\nconsole.log(connector);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.connectors.retrieve',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst connector = await client.beta.connectors.retrieve('connector_id');\n\nconsole.log(connector.id);",
      },
      python: {
        method: 'beta.connectors.retrieve',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.connectors > (method) list_revisions',
    qualified: 'client.beta.connectors.listRevisions',
    params: ['connector_id: string;'],
    response:
      '{ data: { id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: secret_slot_definition[]; }[]; }',
    markdown:
      "## list_revisions\n\n`client.beta.connectors.listRevisions(connector_id: string): { data: connector[]; }`\n\n**get** `/v1beta/connectors/{connector_id}/revisions`\n\n<p>List the full revision lineage of a connector, newest first.</p>\n\n### Parameters\n\n- `connector_id: string`\n  The ID of the connector whose revisions to list.\n\n### Returns\n\n- `{ data: { id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: secret_slot_definition[]; }[]; }`\n\n  - `data: { id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }[]`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst response = await client.beta.connectors.listRevisions('connector_id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.connectors.listRevisions',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.beta.connectors.listRevisions('connector_id');\n\nconsole.log(response.data);",
      },
      python: {
        method: 'beta.connectors.list_revisions',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.runs > (method) list',
    qualified: 'client.beta.runs.list',
    params: ['connector_id: string;', 'cursor?: string;', 'limit?: number;'],
    response:
      '{ id: string; arguments: object; connector_id: string; created_at: string; error: { details: object; exception: string; message: string; retryable: boolean; type: string; }; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }',
    markdown:
      "## list\n\n`client.beta.runs.list(connector_id: string, cursor?: string, limit?: number): { id: string; arguments: object; connector_id: string; created_at: string; error: run_error; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }`\n\n**get** `/v1beta/runs`\n\n<p>List runs of a given connector.</p>\n\n### Parameters\n\n- `connector_id: string`\n  The ID of the connector to list runs for.\n\n- `cursor?: string`\n  Cursor from a previous response's `next_cursor`, to fetch the next page.\n\n- `limit?: number`\n  Maximum number of runs to return.\n\n### Returns\n\n- `{ id: string; arguments: object; connector_id: string; created_at: string; error: { details: object; exception: string; message: string; retryable: boolean; type: string; }; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }`\n\n  - `id: string`\n  - `arguments: object`\n  - `connector_id: string`\n  - `created_at: string`\n  - `error: { details: object; exception: string; message: string; retryable: boolean; type: string; }`\n  - `finished_at: string`\n  - `has_logs: boolean`\n  - `result_json: string`\n  - `status: string`\n  - `secret_bindings?: object`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\n// Automatically fetches more pages as needed.\nfor await (const run of client.beta.runs.list({ connector_id: 'connector_id' })) {\n  console.log(run);\n}\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.runs.list',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const run of client.beta.runs.list({ connector_id: 'connector_id' })) {\n  console.log(run.id);\n}",
      },
      python: {
        method: 'beta.runs.list',
        example:
          'import os\nfrom indices import Indices\n\nclient = Indices(\n    api_key=os.environ.get("INDICES_API_KEY"),  # This is the default and can be omitted\n)\npage = client.beta.runs.list(\n    connector_id="connector_id",\n)\npage = page.data[0]\nprint(page.id)',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.runs > (method) run',
    qualified: 'client.beta.runs.run',
    params: [
      'connector_id: string;',
      'arguments?: object;',
      'async?: boolean;',
    ...
    response:
      '{ id: string; arguments: object; connector_id: string; created_at: string; error: { details: object; exception: string; message: string; retryable: boolean; type: string; }; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }',
    markdown:
      "## run\n\n`client.beta.runs.run(connector_id: string, arguments?: object, async?: boolean, max_timeout_s?: number, secret_bindings?: object): { id: string; arguments: object; connector_id: string; created_at: string; error: run_error; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }`\n\n**post** `/v1beta/runs`\n\n<p>Execute a connector. By default the call blocks until the run finishes. Pass <code>async: true</code> to return immediately, in which case you should poll <code>GET /runs</code> to retrieve the result once it's ready.</p>\n\n### Parameters\n\n- `connector_id: string`\n  ID of the connector to execute.\n\n- `arguments?: object`\n  Arguments to pass to the connector. Optional if the connector does not require any arguments.\n\n- `async?: boolean`\n  When true, return immediately with a pending run; poll retrieveRun for the result.\n\n- `max_timeout_s?: number`\n  Maximum execution time in seconds before the run is timed out.\n\n- `secret_bindings?: object`\n  Mapping of secret slot names to secret IDs. Each slot defined in the connector's required_secrets must be mapped to a user-owned secret.\n\n### Returns\n\n- `{ id: string; arguments: object; connector_id: string; created_at: string; error: { details: object; exception: string; message: string; retryable: boolean; type: string; }; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }`\n\n  - `id: string`\n  - `arguments: object`\n  - `connector_id: string`\n  - `created_at: string`\n  - `error: { details: object; exception: string; message: string; retryable: boolean; type: string; }`\n  - `finished_at: string`\n  - `has_logs: boolean`\n  - `result_json: string`\n  - `status: string`\n  - `secret_bindings?: object`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst run = await client.beta.runs.run({ connector_id: 'connector_id' });\n\nconsole.log(run);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.runs.run',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst run = await client.beta.runs.run({ connector_id: 'connector_id' });\n\nconsole.log(run.id);",
      },
      python: {
        method: 'beta.runs.run',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.runs > (method) retrieve',
    qualified: 'client.beta.runs.retrieve',
    params: ['run_id: string;'],
    response:
      '{ id: string; arguments: object; connector_id: string; created_at: string; error: { details: object; exception: string; message: string; retryable: boolean; type: string; }; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }',
    markdown:
      "## retrieve\n\n`client.beta.runs.retrieve(run_id: string): { id: string; arguments: object; connector_id: string; created_at: string; error: run_error; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }`\n\n**get** `/v1beta/runs/{run_id}`\n\n<p>Retrieve a run by its ID.</p>\n\n### Parameters\n\n- `run_id: string`\n  The ID of the run to retrieve.\n\n### Returns\n\n- `{ id: string; arguments: object; connector_id: string; created_at: string; error: { details: object; exception: string; message: string; retryable: boolean; type: string; }; finished_at: string; has_logs: boolean; result_json: string; status: string; secret_bindings?: object; }`\n\n  - `id: string`\n  - `arguments: object`\n  - `connector_id: string`\n  - `created_at: string`\n  - `error: { details: object; exception: string; message: string; retryable: boolean; type: string; }`\n  - `finished_at: string`\n  - `has_logs: boolean`\n  - `result_json: string`\n  - `status: string`\n  - `secret_bindings?: object`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst run = await client.beta.runs.retrieve('run_id');\n\nconsole.log(run);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.runs.retrieve',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst run = await client.beta.runs.retrieve('run_id');\n\nconsole.log(run.id);",
      },
      python: {
        method: 'beta.runs.retrieve',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.runs > (method) logs',
    qualified: 'client.beta.runs.logs',
    params: ['run_id: string;'],
    response: '{ logs: string; }',
    markdown:
      "## logs\n\n`client.beta.runs.logs(run_id: string): { logs: string; }`\n\n**get** `/v1beta/runs/{run_id}/logs`\n\n<p>Retrieve the combined logs for a run.</p>\n\n### Parameters\n\n- `run_id: string`\n  The ID of the run to get logs for.\n\n### Returns\n\n- `{ logs: string; }`\n\n  - `logs: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst response = await client.beta.runs.logs('run_id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.runs.logs',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.beta.runs.logs('run_id');\n\nconsole.log(response.logs);",
      },
      python: {
        method: 'beta.runs.logs',
        example:
          'import os\nfrom indices import Indices\n\nclient = Indices(\n    api_key=os.environ.get("INDICES_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.beta.runs.logs(\n    "run_id",\n)\nprint(response.logs)',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.secrets > (method) list',
    qualified: 'client.beta.secrets.list',
    response:
      "{ id: string; created_at: string; has_totp: boolean; name: string; secret_type: 'login' | 'string'; updated_at: string; website: string; }[]",
    markdown:
      "## list\n\n`client.beta.secrets.list(): object[]`\n\n**get** `/v1beta/secrets`\n\n<p>List all your secrets. Returns metadata only, not the actual credentials.</p>\n\n### Returns\n\n- `{ id: string; created_at: string; has_totp: boolean; name: string; secret_type: 'login' | 'string'; updated_at: string; website: string; }[]`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst secrets = await client.beta.secrets.list();\n\nconsole.log(secrets);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.secrets.list',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst secrets = await client.beta.secrets.list();\n\nconsole.log(secrets);",
      },
      python: {
        method: 'beta.secrets.list',
        example:
          'import os\nfrom indices import Indices\n\nclient = Indices(\n    api_key=os.environ.get("INDICES_API_KEY"),  # This is the default and can be omitted\n)\nsecrets = client.beta.secrets.list()\nprint(secrets)',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.secrets > (method) create',
    qualified: 'client.beta.secrets.create',
    params: [
      'name: string;',
    ...
    response:
      "{ id: string; created_at: string; has_totp: boolean; name: string; secret_type: 'login' | 'string'; updated_at: string; website: string; }",
    markdown:
      "## create\n\n`client.beta.secrets.create(name: string, secret_type: 'login' | 'string', password?: string, totp_secret?: string, username?: string, value?: string, website?: string): { id: string; created_at: string; has_totp: boolean; name: string; secret_type: 'login' | 'string'; updated_at: string; website: string; }`\n\n**post** `/v1beta/secrets`\n\n<p>Create a new secret. Credentials are stored securely in 1Password.</p>\n\n### Parameters\n\n- `name: string`\n  Human-readable name for the secret.\n\n- `secret_type: 'login' | 'string'`\n  Type of secret: 'login' for credentials, 'string' for simple values.\n\n- `password?: string`\n  Login password. Required for 'login' type.\n\n- `totp_secret?: string`\n  Optional TOTP secret (base32 encoded). Only for 'login' type.\n\n- `username?: string`\n  Login username. Required for 'login' type.\n\n- `value?: string`\n  Secret value. Required for 'string' type.\n\n- `website?: string`\n  Optional website URL for context.\n\n### Returns\n\n- `{ id: string; created_at: string; has_totp: boolean; name: string; secret_type: 'login' | 'string'; updated_at: string; website: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `has_totp: boolean`\n  - `name: string`\n  - `secret_type: 'login' | 'string'`\n  - `updated_at: string`\n  - `website: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst secret = await client.beta.secrets.create({ name: 'name', secret_type: 'login' });\n\nconsole.log(secret);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.secrets.create',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst secret = await client.beta.secrets.create({ name: 'name', secret_type: 'login' });\n\nconsole.log(secret.id);",
      },
      python: {
        method: 'beta.secrets.create',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.secrets > (method) get_totp',
    qualified: 'client.beta.secrets.getTotp',
    params: ['id: string;'],
    response: '{ id: string; code: string; }',
    markdown:
      "## get_totp\n\n`client.beta.secrets.getTotp(id: string): { id: string; code: string; }`\n\n**post** `/v1beta/secrets/{id}/totp`\n\n<p>Generate a current TOTP code for a login secret that has 2FA configured.</p>\n\n### Parameters\n\n- `id: string`\n  The ID of the secret.\n\n### Returns\n\n- `{ id: string; code: string; }`\n\n  - `id: string`\n  - `code: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst response = await client.beta.secrets.getTotp('id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.secrets.getTotp',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.beta.secrets.getTotp('id');\n\nconsole.log(response.id);",
      },
      python: {
        method: 'beta.secrets.get_totp',
        example:
          'import os\nfrom indices import Indices\n\nclient = Indices(\n    api_key=os.environ.get("INDICES_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.beta.secrets.get_totp(\n    "id",\n)\nprint(response.id)',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.secrets > (method) delete',
    qualified: 'client.beta.secrets.delete',
    params: ['id: string;'],
    response: '{ id: string; deleted: boolean; }',
    markdown:
      "## delete\n\n`client.beta.secrets.delete(id: string): { id: string; deleted: boolean; }`\n\n**delete** `/v1beta/secrets/{id}`\n\n<p>Delete a secret. This removes it from both the database and 1Password.</p>\n\n### Parameters\n\n- `id: string`\n  The ID of the secret to delete.\n\n### Returns\n\n- `{ id: string; deleted: boolean; }`\n\n  - `id: string`\n  - `deleted: boolean`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst secret = await client.beta.secrets.delete('id');\n\nconsole.log(secret);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.secrets.delete',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst secret = await client.beta.secrets.delete('id');\n\nconsole.log(secret.id);",
      },
      python: {
        method: 'beta.secrets.delete',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.files > (method) list',
    qualified: 'client.beta.files.list',
    params: [
      'connector_id?: string;',
      'cursor?: string;',
      'filename?: string;',
    ...
    response:
      "{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; }",
    markdown:
      "## list\n\n`client.beta.files.list(connector_id?: string, cursor?: string, filename?: string, limit?: number, order?: 'asc' | 'desc', run_id?: string, sort?: 'name' | 'created_at' | 'size_bytes' | 'source', source?: 'UPLOAD' | 'RUN_OUTPUT'): { id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; }`\n\n**get** `/v1beta/files`\n\n<p>List your files: uploads and run outputs. Default order is newest first.</p>\n\n### Parameters\n\n- `connector_id?: string`\n  Only files produced by runs of this connector.\n\n- `cursor?: string`\n  Cursor from a previous response's `next_cursor`, to fetch the next page.\n\n- `filename?: string`\n  Only files whose name contains this text.\n\n- `limit?: number`\n  Maximum number of files to return.\n\n- `order?: 'asc' | 'desc'`\n  Sort direction.\n\n- `run_id?: string`\n  Only files produced by this run.\n\n- `sort?: 'name' | 'created_at' | 'size_bytes' | 'source'`\n  Column to sort by: name, created_at, size_bytes, or source.\n\n- `source?: 'UPLOAD' | 'RUN_OUTPUT'`\n  Only files from this source.\n\n### Returns\n\n- `{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; }`\n\n  - `id: string`\n  - `content_type: string`\n  - `crc32c: string`\n  - `created_at: string`\n  - `name: string`\n  - `run_id: string`\n  - `size_bytes: number`\n  - `source: 'UPLOAD' | 'RUN_OUTPUT'`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\n// Automatically fetches more pages as needed.\nfor await (const file of client.beta.files.list()) {\n  console.log(file);\n}\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.files.list',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const file of client.beta.files.list()) {\n  console.log(file.id);\n}",
      },
      python: {
        method: 'beta.files.list',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.files > (method) retrieve',
    qualified: 'client.beta.files.retrieve',
    params: ['file_id: string;'],
    response:
      "{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; }",
    markdown:
      "## retrieve\n\n`client.beta.files.retrieve(file_id: string): { id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; }`\n\n**get** `/v1beta/files/{file_id}`\n\n<p>Retrieve a file's metadata by its ID.</p>\n\n### Parameters\n\n- `file_id: string`\n  The ID of the file to retrieve.\n\n### Returns\n\n- `{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; }`\n\n  - `id: string`\n  - `content_type: string`\n  - `crc32c: string`\n  - `created_at: string`\n  - `name: string`\n  - `run_id: string`\n  - `size_bytes: number`\n  - `source: 'UPLOAD' | 'RUN_OUTPUT'`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst file = await client.beta.files.retrieve('file_id');\n\nconsole.log(file);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.files.retrieve',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst file = await client.beta.files.retrieve('file_id');\n\nconsole.log(file.id);",
      },
      python: {
        method: 'beta.files.retrieve',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.files > (method) get_download_url',
    qualified: 'client.beta.files.getDownloadURL',
    params: ['file_id: string;'],
    response: '{ expires_at: string; url: string; }',
    markdown:
      "## get_download_url\n\n`client.beta.files.getDownloadURL(file_id: string): { expires_at: string; url: string; }`\n\n**get** `/v1beta/files/{file_id}/download_url`\n\n<p>Get a short-lived signed URL to download the file bytes directly from storage.</p>\n\n### Parameters\n\n- `file_id: string`\n  The ID of the file to download.\n\n### Returns\n\n- `{ expires_at: string; url: string; }`\n\n  - `expires_at: string`\n  - `url: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst response = await client.beta.files.getDownloadURL('file_id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.files.getDownloadURL',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.beta.files.getDownloadURL('file_id');\n\nconsole.log(response.expires_at);",
      },
      python: {
        method: 'beta.files.get_download_url',
        example:
          'import os\nfrom indices import Indices\n\nclient = Indices(\n    api_key=os.environ.get("INDICES_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.beta.files.get_download_url(\n    "file_id",\n)\nprint(response.expires_at)',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.files > (method) download',
    qualified: 'client.beta.files.download',
    params: ['file_id: string;'],
    markdown:
      "## download\n\n`client.beta.files.download(file_id: string): void`\n\n**get** `/v1beta/files/{file_id}/download`\n\n<p>Redirect to a short-lived signed URL that serves the file bytes.</p>\n\n### Parameters\n\n- `file_id: string`\n  The ID of the file to download.\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nawait client.beta.files.download('file_id')\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.files.download',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nawait client.beta.files.download('file_id');",
      },
      python: {
        method: 'beta.files.download',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.files > (method) delete',
    qualified: 'client.beta.files.delete',
    params: ['file_id: string;'],
    response: '{ id: string; deleted: boolean; }',
    markdown:
      "## delete\n\n`client.beta.files.delete(file_id: string): { id: string; deleted: boolean; }`\n\n**delete** `/v1beta/files/{file_id}`\n\n<p>Delete a file and its stored bytes.</p>\n\n### Parameters\n\n- `file_id: string`\n  The ID of the file to delete.\n\n### Returns\n\n- `{ id: string; deleted: boolean; }`\n\n  - `id: string`\n  - `deleted: boolean`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst file = await client.beta.files.delete('file_id');\n\nconsole.log(file);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.files.delete',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst file = await client.beta.files.delete('file_id');\n\nconsole.log(file.id);",
      },
      python: {
        method: 'beta.files.delete',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.files > (method) create',
    qualified: 'client.beta.files.create',
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.capture_sessions > (method) list',
    qualified: 'client.beta.captureSessions.list',
    response:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.capture_sessions > (method) create',
    qualified: 'client.beta.captureSessions.create',
    params: [
    ...
    response:
      "{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }",
    markdown:
      "## create\n\n`client.beta.captureSessions.create(cookies?: { name: string; value: string; domain?: string; http_only?: boolean; path?: string; secure?: boolean; }[], use_proxy?: boolean): { id: string; browser_session_id: string; created_at: string; iframe_url: string; state: capture_session_state; updated_at: string; }`\n\n**post** `/v1beta/capture_sessions`\n\n<p>Spawn a browser session that records the network traffic of everything done in it.</p><p>Once completed, the capture session is a reusable recording: attach it to a task to generate an API from it.</p>\n\n### Parameters\n\n- `cookies?: { name: string; value: string; domain?: string; http_only?: boolean; path?: string; secure?: boolean; }[]`\n  Initial cookies to set in the browser session.\n\n- `use_proxy?: boolean`\n  If true, spawn the browser session using a proxy.\n\n### Returns\n\n- `{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }`\n\n  - `id: string`\n  - `browser_session_id: string`\n  - `created_at: string`\n  - `iframe_url: string`\n  - `state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst captureSession = await client.beta.captureSessions.create();\n\nconsole.log(captureSession);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.captureSessions.create',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst captureSession = await client.beta.captureSessions.create();\n\nconsole.log(captureSession.id);",
      },
      python: {
        method: 'beta.capture_sessions.create',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.capture_sessions > (method) retrieve',
    qualified: 'client.beta.captureSessions.retrieve',
    params: ['id: string;'],
    response:
      "{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }",
    markdown:
      "## retrieve\n\n`client.beta.captureSessions.retrieve(id: string): { id: string; browser_session_id: string; created_at: string; iframe_url: string; state: capture_session_state; updated_at: string; }`\n\n**get** `/v1beta/capture_sessions/{id}`\n\n<p>Retrieve a capture session by its ID.</p><p>Poll this after requesting completion: the session is a usable recording once <code>state</code> is <code>completed</code>.</p>\n\n### Parameters\n\n- `id: string`\n  The ID of the capture session to retrieve.\n\n### Returns\n\n- `{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }`\n\n  - `id: string`\n  - `browser_session_id: string`\n  - `created_at: string`\n  - `iframe_url: string`\n  - `state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst captureSession = await client.beta.captureSessions.retrieve('id');\n\nconsole.log(captureSession);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.captureSessions.retrieve',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst captureSession = await client.beta.captureSessions.retrieve('id');\n\nconsole.log(captureSession.id);",
      },
      python: {
        method: 'beta.capture_sessions.retrieve',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.capture_sessions > (method) complete',
    qualified: 'client.beta.captureSessions.complete',
    params: ['id: string;'],
    response:
      "{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }",
    markdown:
      "## complete\n\n`client.beta.captureSessions.complete(id: string): { id: string; browser_session_id: string; created_at: string; iframe_url: string; state: capture_session_state; updated_at: string; }`\n\n**post** `/v1beta/capture_sessions/{id}/complete`\n\n<p>Stop recording and finalize the capture session.</p><p>Completion is asynchronous: the browser uploads its recording and the session then transitions to <code>completed</code>. Poll <code>retrieveCaptureSession</code> to observe the transition.</p>\n\n### Parameters\n\n- `id: string`\n  The ID of the capture session to complete.\n\n### Returns\n\n- `{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }`\n\n  - `id: string`\n  - `browser_session_id: string`\n  - `created_at: string`\n  - `iframe_url: string`\n  - `state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst captureSession = await client.beta.captureSessions.complete('id');\n\nconsole.log(captureSession);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.captureSessions.complete',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst captureSession = await client.beta.captureSessions.complete('id');\n\nconsole.log(captureSession.id);",
      },
      python: {
        method: 'beta.capture_sessions.complete',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) beta.capture_sessions > (method) abandon',
    qualified: 'client.beta.captureSessions.abandon',
    params: ['id: string;'],
    response:
      "{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }",
    markdown:
      "## abandon\n\n`client.beta.captureSessions.abandon(id: string): { id: string; browser_session_id: string; created_at: string; iframe_url: string; state: capture_session_state; updated_at: string; }`\n\n**post** `/v1beta/capture_sessions/{id}/abandon`\n\n<p>Discard an in-progress capture session and release its browser.</p>\n\n### Parameters\n\n- `id: string`\n  The ID of the capture session to abandon.\n\n### Returns\n\n- `{ id: string; browser_session_id: string; created_at: string; iframe_url: string; state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'; updated_at: string; }`\n\n  - `id: string`\n  - `browser_session_id: string`\n  - `created_at: string`\n  - `iframe_url: string`\n  - `state: 'active' | 'completing' | 'completed' | 'abandoned' | 'failed'`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst captureSession = await client.beta.captureSessions.abandon('id');\n\nconsole.log(captureSession);\n```",
    perLanguage: {
      typescript: {
        method: 'client.beta.captureSessions.abandon',
        example:
          "import Indices from 'indicesio';\n\nconst client = new Indices({\n  apiKey: process.env['INDICES_API_KEY'], // This is the default and can be omitted\n});\n\nconst captureSession = await client.beta.captureSessions.abandon('id');\n\nconsole.log(captureSession.id);",
      },
      python: {
        method: 'beta.capture_sessions.abandon',
        example:
