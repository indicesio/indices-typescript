...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    response:
      "{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; task_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }",
    markdown:
      "## list\n\n`client.beta.connectors.list(cursor?: string, limit?: number): { id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; task_id: string; website: string; required_secrets?: secret_slot_definition[]; }`\n\n**get** `/v1beta/connectors`\n\n<p>List the connectors in your catalog.</p>\n\n### Parameters\n\n- `cursor?: string`\n  Cursor from a previous response's `next_cursor`, to fetch the next page.\n\n- `limit?: number`\n  Maximum number of connectors to return.\n\n### Returns\n\n- `{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; task_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `display_name: string`\n  - `input_schema: object`\n  - `output_schema: object`\n  - `purpose: string`\n  - `revised_from_connector_id: string`\n  - `task_id: string`\n  - `website: string`\n  - `required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\n// Automatically fetches more pages as needed.\nfor await (const connector of client.beta.connectors.list()) {\n  console.log(connector);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; task_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }",
    markdown:
      "## retrieve\n\n`client.beta.connectors.retrieve(connector_id: string): { id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; task_id: string; website: string; required_secrets?: secret_slot_definition[]; }`\n\n**get** `/v1beta/connectors/{connector_id}`\n\n<p>Retrieve a connector by its ID.</p>\n\n### Parameters\n\n- `connector_id: string`\n  The ID of the connector to retrieve.\n\n### Returns\n\n- `{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; task_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `display_name: string`\n  - `input_schema: object`\n  - `output_schema: object`\n  - `purpose: string`\n  - `revised_from_connector_id: string`\n  - `task_id: string`\n  - `website: string`\n  - `required_secrets?: { name: string; type: 'login' | 'string'; description?: string; supports_totp?: boolean; }[]`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst connector = await client.beta.connectors.retrieve('connector_id');\n\nconsole.log(connector);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; task_id: string; secret_bindings?: object; }",
    markdown:
      "## retrieve\n\n`client.beta.runs.retrieve(run_id: string): { id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; task_id: string; secret_bindings?: object; }`\n\n**get** `/v1beta/runs/{run_id}`\n\n<p>Retrieve a run by its ID.</p>\n\n### Parameters\n\n- `run_id: string`\n  The ID of the run to retrieve.\n\n### Returns\n\n- `{ id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; task_id: string; secret_bindings?: object; }`\n\n  - `id: string`\n  - `arguments: object`\n  - `connector_id: string`\n  - `created_at: string`\n  - `finished_at: string`\n  - `has_logs: boolean`\n  - `result_json: string`\n  - `status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'`\n  - `task_id: string`\n  - `secret_bindings?: object`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst run = await client.beta.runs.retrieve('run_id');\n\nconsole.log(run);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; task_id: string; }",
    markdown:
      "## retrieve\n\n`client.beta.files.retrieve(file_id: string): { id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; task_id: string; }`\n\n**get** `/v1beta/files/{file_id}`\n\n<p>Retrieve a file's metadata by its ID.</p>\n\n### Parameters\n\n- `file_id: string`\n  The ID of the file to retrieve.\n\n### Returns\n\n- `{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT'; task_id: string; }`\n\n  - `id: string`\n  - `content_type: string`\n  - `crc32c: string`\n  - `created_at: string`\n  - `name: string`\n  - `run_id: string`\n  - `size_bytes: number`\n  - `source: 'UPLOAD' | 'RUN_OUTPUT'`\n  - `task_id: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst file = await client.beta.files.retrieve('file_id');\n\nconsole.log(file);\n```",
    perLanguage: {
      typescript: {
