...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; secret_bindings?: object; }",
    markdown:
      "## list\n\n`client.beta.runs.list(connector_id: string, cursor?: string, limit?: number): { id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; secret_bindings?: object; }`\n\n**get** `/v1beta/runs`\n\n<p>List runs of a given connector.</p>\n\n### Parameters\n\n- `connector_id: string`\n  The ID of the connector to list runs for.\n\n- `cursor?: string`\n  Cursor from a previous response's `next_cursor`, to fetch the next page.\n\n- `limit?: number`\n  Maximum number of runs to return.\n\n### Returns\n\n- `{ id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; secret_bindings?: object; }`\n\n  - `id: string`\n  - `arguments: object`\n  - `connector_id: string`\n  - `created_at: string`\n  - `finished_at: string`\n  - `has_logs: boolean`\n  - `result_json: string`\n  - `status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'`\n  - `secret_bindings?: object`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\n// Automatically fetches more pages as needed.\nfor await (const run of client.beta.runs.list({ connector_id: 'connector_id' })) {\n  console.log(run);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; secret_bindings?: object; }",
    markdown:
      "## retrieve\n\n`client.beta.runs.retrieve(run_id: string): { id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; secret_bindings?: object; }`\n\n**get** `/v1beta/runs/{run_id}`\n\n<p>Retrieve a run by its ID.</p>\n\n### Parameters\n\n- `run_id: string`\n  The ID of the run to retrieve.\n\n### Returns\n\n- `{ id: string; arguments: object; connector_id: string; created_at: string; finished_at: string; has_logs: boolean; result_json: string; status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'; secret_bindings?: object; }`\n\n  - `id: string`\n  - `arguments: object`\n  - `connector_id: string`\n  - `created_at: string`\n  - `finished_at: string`\n  - `has_logs: boolean`\n  - `result_json: string`\n  - `status: 'pending' | 'running' | 'success' | 'failed' | 'timed_out' | 'result_too_large' | 'internal_error'`\n  - `secret_bindings?: object`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst run = await client.beta.runs.retrieve('run_id');\n\nconsole.log(run);\n```",
    perLanguage: {
      typescript: {
