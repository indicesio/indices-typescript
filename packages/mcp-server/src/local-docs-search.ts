...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; display_name: string; input_schema: object; output_schema: object; purpose: string; revised_from_connector_id: string; task_id: string; website: string; required_secrets?: { name: string; type: 'login' | 'string'; requires_totp?: boolean; }[]; }",
    markdown:
