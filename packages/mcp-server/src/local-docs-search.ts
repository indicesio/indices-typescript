...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'; task_id: string; }",
    markdown:
      "## list\n\n`client.files.list(cursor?: string, filename?: string, limit?: number, order?: 'asc' | 'desc', run_id?: string, sort?: 'name' | 'created_at' | 'size_bytes' | 'source', source?: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION', task_id?: string): { id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'; task_id: string; }`\n\n**get** `/v1beta/files`\n\n<p>List your files: uploads and run outputs. Default order is newest first.</p>\n\n### Parameters\n\n- `cursor?: string`\n  Cursor from a previous response's `next_cursor`, to fetch the next page.\n\n- `filename?: string`\n  Only files whose name contains this text.\n\n- `limit?: number`\n  Maximum number of files to return.\n\n- `order?: 'asc' | 'desc'`\n  Sort direction.\n\n- `run_id?: string`\n  Only files produced by this run.\n\n- `sort?: 'name' | 'created_at' | 'size_bytes' | 'source'`\n  Column to sort by: name, created_at, size_bytes, or source.\n\n- `source?: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'`\n  Only files from this source.\n\n- `task_id?: string`\n  Only files produced by runs of this task.\n\n### Returns\n\n- `{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'; task_id: string; }`\n\n  - `id: string`\n  - `content_type: string`\n  - `crc32c: string`\n  - `created_at: string`\n  - `name: string`\n  - `run_id: string`\n  - `size_bytes: number`\n  - `source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'`\n  - `task_id: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\n// Automatically fetches more pages as needed.\nfor await (const file of client.files.list()) {\n  console.log(file);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'; task_id: string; }",
    markdown:
      "## retrieve\n\n`client.files.retrieve(file_id: string): { id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'; task_id: string; }`\n\n**get** `/v1beta/files/{file_id}`\n\n<p>Retrieve a file's metadata by its ID.</p>\n\n### Parameters\n\n- `file_id: string`\n  The ID of the file to retrieve.\n\n### Returns\n\n- `{ id: string; content_type: string; crc32c: string; created_at: string; name: string; run_id: string; size_bytes: number; source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'; task_id: string; }`\n\n  - `id: string`\n  - `content_type: string`\n  - `crc32c: string`\n  - `created_at: string`\n  - `name: string`\n  - `run_id: string`\n  - `size_bytes: number`\n  - `source: 'UPLOAD' | 'RUN_OUTPUT' | 'GENERATION' | 'FORGE_SESSION'`\n  - `task_id: string`\n\n### Example\n\n```typescript\nimport Indices from 'indicesio';\n\nconst client = new Indices();\n\nconst file = await client.files.retrieve('file_id');\n\nconsole.log(file);\n```",
    perLanguage: {
      typescript: {
