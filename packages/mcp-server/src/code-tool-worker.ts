...
import { Indices, ClientOptions } from 'indicesio';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Indices)`
    : `const run: (${functionSource.client}: Indices) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.beta.connectors.delete',
    'client.beta.connectors.list',
    'client.beta.connectors.listRevisions',
    'client.beta.connectors.retrieve',
    'client.beta.runs.list',
    'client.beta.runs.logs',
    'client.beta.runs.retrieve',
    'client.beta.runs.run',
    'client.beta.secrets.create',
    'client.beta.secrets.delete',
    'client.beta.secrets.getTotp',
    'client.beta.secrets.list',
    'client.beta.files.create',
    'client.beta.files.delete',
    'client.beta.files.download',
    'client.beta.files.finalize',
    'client.beta.files.getDownloadURL',
    'client.beta.files.list',
    'client.beta.files.retrieve',
    'client.beta.captureSessions.abandon',
    'client.beta.captureSessions.complete',
    'client.beta.captureSessions.create',
    'client.beta.captureSessions.list',
    'client.beta.captureSessions.retrieve',
  ],
